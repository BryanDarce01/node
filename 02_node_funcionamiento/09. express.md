...
# SETEAR MENSAJE SINO SE ENCUENTRA LA RUTA
...
- `app.all` → aplica a todos los métodos HTTP (`GET`, `POST`, etc.)

## ¿Cuándo se ejecuta?

Solo cuando ninguna ruta anterior coincide
...
- Express llega al `app.all('*')`

- devuelve el error

## IMPORTANTE

Siempre debe ir al FINAL del código

Si se pone arriba, bloqueará todas las rutas